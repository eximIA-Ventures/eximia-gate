...
export default function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const res = await fetch("/api/v1/gate/login", {
        method: "POST",
      ...
      <div className="relative z-10 w-full max-w-sm px-4 animate-fade-in">
        ...
        <div className="rounded-2xl border border-[rgba(232,224,213,0.06)] bg-surface/80 backdrop-blur-sm p-6 sm:p-8 shadow-2xl shadow-black/20">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-primary">Bem-vindo</h1>
              <p className="text-xs text-muted">Entre para acessar o ecossistema</p>
            </div>
          </div>
